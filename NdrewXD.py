...
for xd in range(10000):
	...
	b=random.choice(['7.0','8.1.0','9','10','11','12','13']) 
	c= random.choice (['samsung SM-N960U','samsung SM-G973F','OPPO CPH1909','samsung SM-G965U1','samsung SM-A528B','samsung SM-G930F','samsung SM-G955U','realme RMX2185','samsung SM-A528B','OPPO CPH2127'])
	d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36 SurfBrowser/3.0'
	uaku=(f'{a} {b}; {c}) {d}') 
	ugen2.append(uaku)
	...
	b=random.choice(['4.3','5.0','7.0','8.1.0','9','10','11','12','13'])
	c=random.choice(['SM-J111F','SM-G986U','SM-G965F','SM-G985F','SM-J415FN','SM-G965F','Infinix X622','SM-A102U','SM-N910H','Redmi 4X']) 
	d='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
	uaku2=f'{a} {b}; {c}) {d}'
	ugen.append(uaku2) 
	
	a='Mozilla/5.0 (Linux; Android 7.1.1; SM-J250F Build/NMF26X) AppleWebKit/537.36 (KHTML, like Gecko) Chrom/64.0.3282.137 Mobile Safari/537.36'
	uaku2=f'{a}'
	ugen.append(uaku2) 
...
for brayen in range(10000):
    ...
    b = random.choice(['3','4','5','5.0.1','6','6.0.1','7','7.0','7.1.1','8','8.0','8.0.1','8.1.1','8.1.0','9','10','11','12','13'])
    merk = random.choice(['SM-A326K','P13 PRO','SM-A325F','Nokia 5.4','SM-A202F','SM-A326B','SM-A105FN','SM-G610M','L10','X2_euro','ONEPLUS A3010','SAMSUNG-SM-G930A','SAMSUNG-SM-G925A','LG-M250']) 
    merk1 = random.choice(['NokiaE7-00','Nokia5800d-1','Nokia5230','NokiaC6-01','NokiaE5-00','Nokia500','NokiaC5-06']) 
    c=random.choice(['OPM1','TP1A','RP1A','PPR1','PKQ1','QP1A','SP1A','RKQ1','LRX22G','LRX22C','LMY48B','LMY47X','MMB29K','NMF26X'])
    d=random.choice(['Version','SamsungBrowser'])
    e='Mozilla/5.0 (Windows NT'
    king = f'{a} {b}; {merk}) AppleWebKit/{str(rr(500,600))}.{str(rr(30,60))} (KHTML, like Gecko) Chrome/{str(rr(20,150))}.0.{str(rr(4000,6000))}.{str(rr(20,200))} Mobile Safari/537.36'
    king1 = f'{a} {b}; {merk} Build/{c}.{str(rr(100000,200000))}.0{str(rr(10,20))}) AppleWebKit/{str(rr(500,600))}.{str(rr(30,60))} (KHTML, like Gecko) {d}/{str(rr(4,20))}.0 Chrome/{str(rr(20,150))}.0.{str(rr(4000,6000))}.{str(rr(20,200))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(100,1000))}.0.0.{str(rr(10,100))}.{str(rr(100,500))};]'
    king2 = f'{a} {b}; {merk} Build/{c}.{str(rr(100000,200000))}.0{str(rr(10,20))}; wv) AppleWebKit/{str(rr(500,600))}.{str(rr(30,60))} (KHTML, like Gecko) {d}/{str(rr(4,20))}.0 Chrome/{str(rr(20,150))}.0.{str(rr(4000,6000))}.{str(rr(20,200))} Mobile Safari/537.36 GNews Android/{str(rr(2000000000,3000000000))}'
    king3 = f'{a} {b}; {merk}) AppleWebKit/{str(rr(500,600))}.{str(rr(30,60))} (KHTML, like Gecko) Chrome/{str(rr(20,150))}.0.{str(rr(4000,6000))}.{str(rr(20,200))} Safari/537.36'
    king4 = f'{e} {str(rr(6,10))}.0) AppleWebKit/{str(rr(500,600))}.{str(rr(30,60))}(KHTML, like Gecko) Chrome/{str(rr(20,150))}.0.{str(rr(4000,6000))}.{str(rr(20,200))} Safari/537.36 Edg/{str(rr(80,90))}.0.{str(rr(500,650))}.{str(rr(1,100))}'
    king5 = f'Mozilla/5.0 (Symbian/3; Series60/{str(rr(5,9))}.{str(rr(1,9))} {merk1}/{str(rr(100,120))}.0{str(rr(20,60))}.{str(rr(1000,2000))}; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/{str(rr(1,9))}.{str(rr(1,9))}.{str(rr(1,9))}.{str(rr(1,9))} Mobile Safari/535.1'
    UaMainn = random.choice([king,king1,king2,king3,king4,king5]) 
    ugen.append(UaMainn)
